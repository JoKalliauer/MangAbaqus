...
%university:TU Wien
 ...
 format longG
  ...
  modelprops.lambda = 0:epsil:.9;10;%3.725;%10;%2.19;%1.5;%2.169;%3.72; %0:0.01:5.68 %(0.78-4*epsil); % do not go over snap-through point 5*epsil:10*epsil:(0.78-4*epsil)
