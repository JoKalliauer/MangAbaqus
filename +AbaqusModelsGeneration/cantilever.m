function [filename,lambda,BC,Nodes,Elements]  = cantilever(L,numofelm,lambda,loadFactor,elType)
if nargin<1
    L = 5.0;
end
if nargin<2
...
filename = ['cantileverBeam-',elType,'-',num2str(numofelm(end)),'-len-',num2str(L),'-loadfac-',num2str(loadFactor)];
