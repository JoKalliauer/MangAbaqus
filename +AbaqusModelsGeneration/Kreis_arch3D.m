...
= Kreis_arch3D(~,numofelm,lambda,loadFactor,eltype,AbaqusRunsFolder,modelprops)
razem = [];
if nargin<1
    lambda = 0.01:0.01:1;
%     lambda = 0.1;
...
%fprintf(u2,'*Output, field, variable=PRESELECT\n');
    fprintf(u2,'*Output, field\n');
    fprintf(u2,'*Node Output\n');
    fprintf(u2,'CF, RF, TF, U\n');
    fprintf(u2,'*Element Output, directions=YES\n');
