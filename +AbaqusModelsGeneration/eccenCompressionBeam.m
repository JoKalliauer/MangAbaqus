function [filename,lambda,BC,Nodes,Elements]  = eccenCompressionBeam(L,numofelm,lambda,loadFactor,elType,ecc)
if nargin<1
    L = 5.0;
end
if nargin<2
...
filename = ['eccenCompressionBeam-',elType,'-',num2str(numofelm(end)),'-len-',num2str(L),'-ecc-',num2str(ecc),'-loadfac-',num2str(loadFactor)];
