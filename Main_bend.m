...
%   modelprops.elementtype = eltype;
  ...
  modelprops.lambda = 0:modelprops.epsilon:max(.7,30*modelprops.epsilon);%10; %(0.78-4*epsil); % do not go over snap-through point 5*epsil:10*epsil:(0.78-4*epsil)
...
% % % % % % % % %numelem
% numofelms = {2,4,8,16,32,64,128,256};%numofelms = {2,5,10,20,50,100,200,500,1000,2000}
