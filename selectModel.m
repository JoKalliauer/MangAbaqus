function model = selectModel(modelprops)
if nargin<1
    testcase = 'TL_arch';
    numofelm = 20;
    eltype = 'B21';
   ...
   switch testcase
       ...
       case 'TL_arch3D'
           [filename,lambda,BC,Nodes,Elements] = AbaqusModelsGeneration.TL_arch3D([],numofelm,lambda,loadFactor,eltype);
       case 'TL_arch_Hinge'
       ...
       case 'pureBendingBeam'
           [filename,lambda,BC,Nodes,Elements] = AbaqusModelsGeneration.pureBendingBeam(len,numofelm,lambda,loadFactor,eltype);
       case 'cantilever'
           [filename,lambda,BC,Nodes,Elements] = AbaqusModelsGeneration.cantilever(len,numofelm,lambda,loadFactor,eltype);
