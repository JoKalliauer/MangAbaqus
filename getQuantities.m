function [v,a,speed,accel,at,an,rho,tau,ortCond1,rho2, drddr, cosmu, sinpsi, ortCond2,ortCond3,ortCond4, T, N, B, R, V, A] = getQuantities(RS,dksi,DT)
...
%    ortCond1 = abs((v'*v)./(r0'*a));
   ...
   cosmu = (r0'*a)/norm(a);
   cosmu = abs((r0'*(r01 - 2*r0 + r11))/norm(r01 - 2*r0 + r11));
