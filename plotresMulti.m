...
if main.savefigures==true
 if ~exist('Output/Figures/', 'dir') || ~exist('C:\Data\Abauqs\MangAbaqus\Output\Figures\', 'dir')
  if isunix
  ...
  elseif ispc
   ...
   mkdir('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG');
   mkdir('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG');
   mkdir('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF');
  elseif ismac
...
%   end
 ...
 if ismember(60, plotfig)
    figure(60);
    set(gcf, 'PaperUnits', 'points', 'PaperPositionMode', 'auto', ...
             'PaperOrientation', 'landscape', ...
             'Position', [FesterPosXNR(plotfig == get(gcf, 'Number')), FesterPosY, XBreite, YHohe]);
    hold on;

    % 计算数据
    NrValues = min(numel(lambda) - 1, numel(res(k3).RHO) - 1);
    lambda = lambda(2:NrValues);
    RHO = RHO(2:NrValues);
    lambda_centers = (lambda(1:end-1) + lambda(2:end)) / 2;
    drho = diff(RHO);
    dlambda = diff(lambda);
    drho_dlambda = drho ./ dlambda;
    RHO_centers = (RHO(1:end-1) + RHO(2:end)) / 2;
    numerator = RHO_centers + drho_dlambda.^2;
    denominator = 1 + drho_dlambda.^2;
    Y = numerator ./ denominator;

    % 绘图
    plot(lambda_centers, Y, 'LineStyle', '-', 'Marker', markJK, 'LineWidth', 1.5, 'Color', colJK);

    % 坐标轴标签和标题
    xlabel('$\lambda$', 'Interpreter', 'latex');
    ylabel('$\frac{\rho+\frac{\partial \rho}{\partial \lambda} ^2}{1+\frac{\partial \rho}{\partial \lambda} ^2}$', 'Interpreter', 'latex');
    bbb = gca();
    bbb.XLim = [0 inf];
    grid on;
    title(modelfilename, 'Interpreter', 'none');
    ...
    % 保存图形
    if savefigures
            print('-dsvg', strcat('Output/Figures/SVG/', modelfilename, '_rho_fracrho.svg'));
...
% markJK=MyMarker(mod(k3+main.colorshift-1,2)+1);
 ...
 xend=min(numel(lambda),numel(LAM));
  ...
  title(modelfilename)
  if model.savefigures==true
  print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_chi.svg'))
  print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_chi.png'))
  print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_chi.pdf'),'-dpdf')
  end
 end
...
%fignr=2; %fignr=02;
 if ismember(2,plotfig)
  ...
  bbb.YAxisLocation = 'origin';
  if savefigures==true
  print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_rho.svg'))
  print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_rho.png'))
  print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_rho.pdf'),'-dpdf')
  end
 end
 if ismember(-2,plotfig)
  disp([lambda(2:end),RHO(2:end)])
 ...
 if ismember(3,plotfig)
  ...
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_velocity.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_velocity.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_velocity.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(3.3,plotfig)
  ...
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_velocity3D.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_velocity3D.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_velocity3D.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(4,plotfig)
  ...
  grid on
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_tanacceleration.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_tanacceleration.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_tanacceleration.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(5,plotfig)
  ...
  grid on
  if model.savefigures==true
  print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\',modelfilename,'_noracceleration.svg'))
  print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\',modelfilename,'_noracceleration.png'))
  end
 end
 ...
 if ismember(6,plotfig)
  ...
  grid on
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\',modelfilename,'_totacceleration.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\',modelfilename,'_totacceleration.png'))
   print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_totAcc6.pdf'),'-dpdf')
  end
 end
 ...
 if ismember(7,plotfig)
  ...
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_torque.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_torque.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_torque.pdf'),'-fillpage')
  end
  disp(median(abs(res(k3).TAU(2:end)),'omitnan'));
 end
 ...
 if ismember(8,plotfig)
  ...
  grid on
  if model.savefigures==true
  print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_SinCos.svg'))
  print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_SinCos.png'))
  print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_SinCos.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(8.1,plotfig)
  ...
  grid on
  if model.savefigures==true
  print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_Sin-Cos.svg'))
  print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_Sin-Cos.png'))
  print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_Sin-Cos.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(11,plotfig) && numel(LAM)>0
  ...
  ylim([min(-0.1,max(real(LAM(end)),-0.2)),max(min(real(LAM(end)),2),1)])
  if model.savefigures==true
  print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_LAM.svg'))
  print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_LAM.png'))
  print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_LAM.pdf'),'-dpdf')
  end
  if ismember(11.1,plotfig)
   ylim([-.1,.1])
   if model.savefigures==true
    print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_LAMX.svg'))
    print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_LAMX.png'))
    print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_LAMX.pdf'),'-fillpage')
   end
  end
 end
 if ismember(-11,plotfig)
 ...
 if ismember(12,plotfig)
  ...
  aaa.XLim = [0 inf];
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_LAM12.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_LAM12.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_LAM12.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(13,plotfig)
  ...
  grid on
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_LAM13.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_LAM13.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_LAM13.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(14,plotfig) && isstruct(res)
  ...
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_rho14.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_rho14.png'))
   print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_rho14.pdf'),'-dpdf')
  else
   title(modelfilename)
  end
  %disp(median(res(k3).RHO2(2:lamlast),'omitnan'));
...
%fignr=15
 if ismember(15,plotfig)
  ...
  if strcmp(main.typeofanalysis,'KNL2')
   ...
   dianame=strcat(modelfilename,figname);
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',dianame,'.svg'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',dianame,'.pdf'),'-fillpage')
   %print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_LAM15.png'))
  elseif savefigures==2
    cfig('NaNs')='keep';
    cfig('closing')=NaN;
    cfig('lineColor')=colJK;
 ...
 if ismember(16,plotfig)
  ...
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_EWd2l.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_EWd2l.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_EWd2l.pdf'),'-fillpage')
  end
%   if ismember(16.1,plotfig)
%    ylim([-inf 0])
%    if model.savefigures==true
%     print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_EWd2lneg.svg'))
%     print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_EWd2lneg.png'))
%     print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_EWd2lneg.pdf'),'-fillpage')
%    end
%   end
 end
 ...
 if ismember(17,plotfig)
  ...
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_OC6.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_OC6.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_OC6.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(18,plotfig)
  ...
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_OC7.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_OC7.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_OC7.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(19,plotfig)
  ...
  %aaa.XLim = [0 inf];
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_LAM19.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_LAM19.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_LAM19.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(20,plotfig)
  ...
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_rhorho3D.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_rhorho3D.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_rhorho3D.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(21,plotfig)
  ...
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_CosPhi.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_CosPhi.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_CosPhi.pdf'),'-fillpage')
  end
  ...
  if ismember(211,plotfig)
   ...
   if savefigures==true
    print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_X1.svg'))
    print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_X1.png'))
    print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_X1.pdf'),'-fillpage')
   end
   %fignr=212
   figure(212);
   set(gcf,'PaperUnits','points','PaperPositionMode','auto','PaperOrientation','landscape','Position',[XBreite   0   XBreite   YHohe]); 
   ...
   ylim([-1.2,-0.8])
   if savefigures==true
    print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_X2.svg'))
    print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_X2.png'))
    print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_X2.pdf'),'-fillpage')
   end
   figure(213);
   set(gcf,'PaperUnits','points','PaperPositionMode','auto','PaperOrientation','landscape','Position',[2*XBreite   0   XBreite   YHohe]); 
   hold on
   ...
   if savefigures==true
    print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_X3.svg'))
    print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_X3.png'))
    print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_X3.pdf'),'-fillpage')
   end
   figure(214);
   set(gca,'FontSize',FontSize*Faktor,'FontName',FontName,'XAxisLocation','origin')
   set(gcf,'PaperUnits','points','PaperPositionMode','auto','PaperOrientation','landscape','Position',[3*XBreite   0   XBreite   YHohe]); 
   ...
   if savefigures==true
    print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_X4.svg'))
    print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_X4.png'))
    print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_X4.pdf'),'-fillpage')
   end
  end
 ...
 if ismember(22,plotfig)
  ...
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_OC5.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_OC5.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_OC5.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(23,plotfig)
  ...
  %bbb.XLim = [0 inf];
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_HYPO.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_HYPO.png'))
   print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_HYPO.pdf'),'-dpdf')
  end
 end
 ...
 if ismember(24,plotfig)
  ...
  bbb.XLim = [0 inf];
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_tau.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_tau.png'))
   print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_tau.pdf'),'-dpdf')
  end
 end
 if ismember(24.3,plotfig)
  figure(243);
  ...
  bbb.XLim = [0 inf];
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_tau_3D.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_tau_3D.png'))
   print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_tau_3D.pdf'),'-dpdf')
  end
 end
 ...
 if ismember(25,plotfig)
  ...
  bbb.XLim = [0 inf];
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_ABSrddd.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_ABSrddd.png'))
   print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_ABSrddd.pdf'),'-dpdf')
  end
 end
 ...
 if ismember(26,plotfig)
  ...
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_RxB_26.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_RxB_26.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_RxB_26.pdf'),'-fillpage')
  end
  disp(median(res(k3).RXB(2:end),'omitnan'));
 end
 ...
 if ismember(27,plotfig)
  ...
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_RxB3D_27.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_RxB3D_27.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_RxB3D_27.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(28,plotfig)
  ...
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'Rconst.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'Rconst.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'Rconst.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(29,plotfig)
  ...
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'EBENE.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'EBENE.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'EBENE.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(30,plotfig)
  ...
  %bbb.XLim = [0 60];
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_rho30.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_rho30.png'))
   print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_rho30.pdf'),'-dpdf')
   if export && savefigures>1 
    h8030=figure(8030);
    plotitJK(xValload,res(k3).RHO2(2:end),'Output/',xlabelload,ylabelJK,strcat(modelfilename,'_rho30'),cfig,h8030)% %#ok<UNRCH>
   end
 ...
 if ismember(31,plotfig)
  ...
  %bbb.XLim = [0 inf];
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_rho31.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_rho31.png'))
   print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_rho31.pdf'),'-dpdf')
   if export
    plotitJK(xValload,1-res(k3).RHO2(2:end),'Output/Figures/',xlabelload,ylabelJK,strcat(modelfilename,'_rho31'),NaN,NaN,cfig)% %#ok<UNRCH>
   end
  end
 ...
 if ismember(32,plotfig)
  ...
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_RxB_32.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_RxB_32.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_RxB_32.pdf'),'-fillpage')
   if export
    cfig('yMin')=-1;% %#ok<UNRCH>
    %plotitJK(xValload,res(k3).RXB(2:end),'Output/Figures/',xlabelload,ylabelJK,strcat(modelfilename,'_RxB_32'),cfig)
   end
 ...
 if ismember(33,plotfig)
  ...
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'PHIR33.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'PHIR33.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'PHIR33.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(34,plotfig)
  ...
  if model.savefigures==true
   %print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'PHIR.svg'))
   %print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'PHIR.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'DrhopDs34.pdf'),'-fillpage')
  end
  disp(median(-res(k3).DrhopDs(2:end),'omitnan'));
  disp(median(abs(res(k3).DrhopDs(2:end)),'omitnan'));
 end
...
%     untergr   =min(max(min(y4),-1),-1);
  ...
  %ylim([.1,.7])
  if savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_LAM35.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_LAM35.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_LAM35.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(36,plotfig)
  ...
  if savefigures~=2
   ...
   if savefigures==true
    print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',dianame,'.pdf'),'-fillpage')%dianame=strcat(modelfilename,figname);
   end
  end
  if savefigures==2
   cfig('wofuer')='TeX';
 ...
 if ismember(37,plotfig)
  ...
  if model.savefigures==true
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_LAM37.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_LAM37.png'))
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_LAM37.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(38,plotfig)
  ...
  if model.savefigures==true
   dianame=strcat(modelfilename,'_cosphi38');
   print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',dianame,'.svg'))
   print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',dianame,'.png'))
   print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',dianame,'.pdf'),'-dpdf')
  end
 end
 ...
 if ismember(43,plotfig) && numel(LAM)>0
  ...
  ylim([min(-1,max(real(LAM(end)),-0.2)),max(min(real(LAM(end)),2),1)])
  if savefigures==true
  print('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\',modelfilename,'_LAM43.svg'))
  print('-dpng',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\',modelfilename,'_LAM43.png'))
  print('-fillpage',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'_LAM43.pdf'),'-dpdf')
  end
...
if ismember(60, plotfig)
    ...
    lambda = xPlot(2:NrValues);
    RHO = res(k3).RHO2(2:NrValues);
    lambda_centers = (lambda(1:end-1) + lambda(2:end)) / 2;
    drho = diff(RHO);
    dlambda = diff(lambda);
    drho_dlambda = drho ./ dlambda;
    ...
    if savefigures
        if isunix
            ...
            print('-fillpage', strcat('Output/Figures/PDF/', modelfilename, '_rho_fracrho.pdf'), '-dpdf');
        elseif ispc
            print('-dsvg', strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\SVG\', modelfilename, '_rho_fracrho.svg'));
            print('-dpng', strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PNG\', modelfilename, '_rho_fracrho.png'));
            print('-fillpage', strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\', modelfilename, '_rho_fracrho.pdf'), '-dpdf');
        end
    end
end
end %for k3
...
elseif ispc
 ...
 if ismember(900,plotfig)
  ...
  %end
  if main.savefigures==true
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'DetKt900.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(901,plotfig)
  ...
  %end
  if main.savefigures==true
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'sqrtDetKt901.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(906,plotfig) || ismember(902,plotfig)
  ...
  if main.savefigures>=true && ismember(906,plotfig)
   ...
   if main.savefigures==2
    ...
    cfig('xMin')=-1.5;
    cfig('xMax')=1.5;
    plotitJK(xPlotHalf(1:numel(yPlot)),yPlot,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',lambdaLabel,yLabel,dianame,cfig,8906);
   end
  end
 end
...
%   xLabel=xlabelload;%'$\lambda$';
  ...
  if main.savefigures>=true
   ...
   if main.savefigures==2
    ...
    h8902=figure(8902);
    if main.flipAxis
     plotitJK(yPlot,xPlot0(1:NrPlot),'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',yLabel,lambdaLabel,dianame,cfig,h8902);
     plot(y(idxs),lambdaplot(idxs),'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',1.5,'MarkerFaceColor',[1 1 1])
    else
     plotitJK(xPlot0(1:NrPlot),yPlot,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',lambdaLabel,yLabel,dianame,cfig,h8902);
     plot(lambdaplot(idxs),y(idxs),'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',1.5,'MarkerFaceColor',[1 1 1])
    end
    print ('-depsc',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',dianame,'.eps'))
    print ('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',dianame,'.svg'))
   end
  end
  %disp([xPlot,yPlot])
  %format longG
 ...
 if ismember(9021,plotfig)
  ...
  if main.savefigures>=true
   ...
   if main.savefigures==2
    cfig('yMax')=3;
    plotitJK(xPlot,yPlot,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',xlabelload,yLabel,dianame,cfig,89021);
    %plot(lambdaplot(idxs),y(idxs),'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',3,'MarkerFaceColor',[1 1 1])
   end
  end
 end
...
%   xLabel=xlabelload;%'$\lambda$';
  ...
  if main.savefigures>=true
   ...
   if main.savefigures==2
    cfig('yMax')=3;
    plotitJK(xPlot,yPlot,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',xlabelload,yLabel,dianame,cfig,89022);
    %plot(lambdaplot(idxs),y(idxs),'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',3,'MarkerFaceColor',[1 1 1])
   end
  end
 end
 ...
 if ismember(903,plotfig)
  ...
  %end
  if main.savefigures==true
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'dxi903.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(904,plotfig)
  ...
  %end
  if main.savefigures==true
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'dxi904.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(905,plotfig)
  ...
  grid minor
  if main.savefigures==true
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'dxidl905.pdf'),'-fillpage')
  end
 end
...
%   plot(lambdaplot,cell2mat(model.arclengthuHM),'LineStyle','-.','Marker',markJK,'LineWidth',1.5,'Color',MyColours{3});
  ...
  %end
  if main.savefigures==true
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'xi907.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(909,plotfig) || ismember(908,plotfig)
  ...
  idxs=markMins(lambdaplot0,y4);
  if main.savefigures==true
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'dldw909.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(908,plotfig)
  ...
  if main.savefigures>=true
   ...
   if main.savefigures==2
    ...
    cfig('lineColor')=MyColours{1};
    if main.flipAxis
     plotitJK(y4,x,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',yLabel,lambdaLabel,dianame,cfig,h8908);
     plot(y4(idxs),x(idxs),'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',1.5,'MarkerFaceColor',[1 1 1])
    else
     plotitJK(x,y4,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',lambdaLabel,yLabel,dianame,cfig,h8908);
     plot(x(idxs),y4(idxs),'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',1.5,'MarkerFaceColor',[1 1 1])
    end
    %plotitJK(x,y4,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',lambdaLabel,yLabel,dianame,cfig,h8908);
    title('(a)')
...
%   plot(lambdaplot,cell2mat(model.arclengthuHM),'LineStyle','-.','Marker',markJK,'LineWidth',1.5,'Color',MyColours{3});
  ...
  %end
  if main.savefigures==true
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'w911.pdf'),'-fillpage')
  end
 end
...
%   [miny4,idx]=min(y4);
 ...
 if ismember(913,plotfig)
  ...
  elseif main.savefigures==2
   ...
   h8913=figure(8913);
   hold on
   plotitJK(xPlot,yPlot,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',lambdaLabel,yLabel,dianame,cfig,h8913);
   title('(b)')
   markMins(xPlot,yPlot);
   remove(cfig,{'yMax'});
   %markMins(xPlot,yPlot,gca());
...
%   xLabel='$\lambda$';
  ...
  if main.savefigures>=true
   ...
   if main.savefigures==2
    ...
    cfig('XAxisLocation')='bottom';
    h8914=figure(8914);
    plotitJK(xPlot,y4,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',lambdaLabel,yLabel,dianame,cfig,h8914);
    %title('(b)')
    if k3==resEWs(1) && main.colorshift==0
     xline(0,'k','LineWidth',1)
     plot(xPlot,zeros(size(xPlot)),'Color',[0 0 0],'LineWidth',1)
 ...
 if ismember(915,plotfig)
  ...
  markMins(lambdaplot,y4);
  if main.savefigures==true
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'dldw915.pdf'),'-fillpage')
  end
 end
 ...
 if ismember(916,plotfig)
  ...
  if main.savefigures>=true
   ...
   if main.savefigures==2
    ...
    h8916=figure(8916);
    if main.flipAxis
     plotitJK(y4,x,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',yLabel,lambdaLabel,dianame,cfig,h8916);
     plot(y4(idxs917),x(idxs917),'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',1.5,'MarkerFaceColor',[1 1 1])
    else
     plotitJK(x,y4,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',lambdaLabel,yLabel,dianame,cfig,h8916);
     plot(x(idxs917),y4(idxs917),'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',1.5,'MarkerFaceColor',[1 1 1])
    end
    %plotitJK(x,y4,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',lambdaLabel,yLabel,dianame,cfig,h8916);
    title('(b)')
 ...
 if ismember(918,plotfig) ||  ismember(919,plotfig) || ismember(920,plotfig)|| ismember(969,plotfig)
  ...
  if ismember(920,plotfig)
   ...
   if main.savefigures>=true
    ...
    if main.savefigures==2
     h8920=figure(8920);
     %plotitJK(x,y4,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',xlabelload,yLabel,dianame,cfig,h8920);
     plot(x(idxs),y4(idxs),'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',3,'MarkerFaceColor',[1 1 1])
     plotitJK(x,y4,'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',xlabelload,yLabel,dianame,cfig,h8920);
     %print ('-depsc',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',dianame,'_.eps'))
    end
   end
  end
 end
...
%   end
 ...
 fignr=960;
  ...
  grid minor
  if main.savefigures==true
   print('-dpdf',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PDF\',modelfilename,'d2xidl2_',num2str(fignr),'.pdf'),'-fillpage')
  end
  end
 ...
 if ismember(fignr,plotfig)
  ...
  [~,idxs]=max(model.duEdl);
   ...
   if main.savefigures>=true
    ...
    if main.savefigures==2
     h8fignr=figure(8000+fignr);
     plotitJK(x,yPlot(1:steps),'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\','$\lambda$',yLabel,dianame,cfig,h8fignr);
     plot(x(idxs),yPlot(idxs),'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',3,'MarkerFaceColor',[1 1 1])
     title('(b)')
     print ('-depsc',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',dianame,'.eps'))
     print ('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',dianame,'.svg'))
  ...
  [~,xPoints,yHalfPoints,~] =markWende(x,yPlot);
   ...
   if main.savefigures>=true
    ...
    if main.savefigures==2
     h8fignr=figure(8000+fignr);
     %plot(xPoints,yHalfPoints,'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',3,'MarkerFaceColor',[1 1 1])
     plotitJK(x,yPlot(1:steps),'C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\','$s$',yLabel,dianame,cfig,h8fignr);
     plot(xPoints,yHalfPoints,'o','Color',[0 0 0],'MarkerSize',12,'LineWidth',3,'MarkerFaceColor',[1 1 1])
     %title('(b)')
     print ('-depsc',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',dianame,'.eps'))
     print ('-dsvg',strcat('C:\Data\Abaqus\MangAbaqus\Output\Figures\PlotIt\',dianame,'.svg'))
